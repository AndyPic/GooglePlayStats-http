...
<head>
    ...
    <title>Google Play Stats - All Pitches</title>
    ...
    <script src="js/all_pitches.js"></script>
</head>

<body onload="getPitchData(); loadMorePitches(params)">
    <!-- Navigation bar -->
        ...
        <div class="app-bar">
            ...
            <div class="hidden posRel" id="advanced-search-panel">
                ...
                <div id="radio-buttons">
                    ...
                    <label class="radio-container">Votes
                        <input id="sort-votes" type="radio" name="order" value="votes">
                        <span class="checkmark"></span>
                    </label>
                </div>
            </div>
